...
A fun browser-based treasure hunt for kids with 10 missions. When all missions are complete, the prize link opens automatically!
...
3. When all 10 are done, the prize link opens automatically (YouTube links open in the YouTube app on phones).
...
- **`TREASURE_LINK`** — Set your prize URL (YouTube videos open in the YouTube app on mobile).
...
- Prize link opens automatically when the final mission is completed
- YouTube links open in the YouTube app on mobile
